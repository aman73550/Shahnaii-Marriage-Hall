...
const galleryImages = [
  {
    id: 1,
    src: "/images/hero-exterior-night.png",
    alt: "Shahnaii Marriage Hall - Exterior at Night",
    label: "Venue Exterior",
  },
  {
    id: 2,
    src: "/images/gallery-stage.png",
  ...
  },
  {
    ...
    alt: "Grand Dining Setup",
    label: "Royal Dining",
  },
  {
    id: 4,
    src: "/images/gallery-bridal-suite.png",
    alt: "Bridal Suite",
    label: "Bridal Suite",
  },
  {
    ...
    alt: "Ornate Hall Corridor",
    label: "Grand Corridor",
  },
  {
    id: 6,
    src: "/images/gallery-reception.png",
    alt: "Night Reception Setup",
    label: "Night Reception",
  },
  {
    id: 7,
    src: "/images/gallery-aerial.png",
    alt: "Aerial View of Decorated Hall",
    label: "Aerial View",
  },
  {
    id: 8,
    src: "/images/gallery-centerpiece.png",
    alt: "Table Centerpiece Decoration",
    label: "Centerpiece",
  },
  {
    id: 9,
    src: "/images/gallery-entrance-night.png",
    alt: "Entrance and Parking at Night",
